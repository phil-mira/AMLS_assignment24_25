...
def display_incorrect_images(data, labels, predictions, model_name, data_type):
    ...
    incorrect_predictions_0 = np.random.choice(incorrect_predictions_0[0], 4)
    correct_predictions_0 = np.random.choice(correct_predictions_0[0], 4)
    incorrect_predictions_1 = np.random.choice(incorrect_predictions_1[0], 4)
    correct_predictions_1 = np.random.choice(correct_predictions_1[0], 4)
